# Try Hack Me - [Protocols and Servers](https://tryhackme.com/room/protocolsandservers)
...
![](images/7102401bfd9313a5beb5e23ae93ff17f.png)
...
![](images/a23a13cef49ae7fff87bfd94f6a175dc.png)
...
![](images/da71a52fddfbb268dc6c5857daf07f18.png)
...
* [ProFTPD](http://www.proftpd.org/https://www.uftpserver.com/)
...
```
Using an FTP client, connect to the VM and try to recover the flag file. What is the flag?Username: frankPassword: D2xc9CgD
...
![](images/822a449fd569c16c875a13ca2487b714.png)
...
![](images/ed910ad418376edc846846fc2a0dd3f6.png)
...
```
How many email messages are available to download via IMAP on MACHINE_IP?
> 0
```
